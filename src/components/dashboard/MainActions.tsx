      ...
      <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30">
        ...
        <CardContent className="relative p-8">
          <div className="flex flex-col md:flex-row items-center md:items-center gap-4 mb-6 text-center md:text-left">
            <div
              className="w-16 h-16 bg-linear-to-br from-primary/20 to-primary/10 
          ...
          <Link
            ...
            className={buttonVariants({
              variant: "default",
              className:"w-full mt-6 bg-linear-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-white font-semibold py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300",
            })}
          >
