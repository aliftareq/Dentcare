            ...
            <div key={index} className="relative group">
              ...
              >
                <div className="space-y-6">
                  ...
                  {/* Button Logic */}
                  {pkg.button.type === "signup" ? (
                    <SignUpButton mode="modal">
                      <Button className="w-full">{pkg.button.label}</Button>
                    </SignUpButton>
                  ) : (
                    <Button
                      variant={pkg.button.type === "outline" ? "outline" : "default"}
                      className="w-full"
                    >
                      {pkg.button.label}
                    </Button>
