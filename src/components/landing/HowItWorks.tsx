...
function HowItWorks() {
  return (
    <section className="relative py-16 px-6 outline-hidden z-10 max-w-7xl mx-auto">
      {/* HEADER */}
        ...
        <div className="grid lg:grid-cols-3 gap-12 lg:gap-8">
          ...
          <div className="relative group">
            <div className="relative bg-linear-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
              {/* Step Number */}
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 w-8 h-8 bg-linear-to-br from-primary to-primary/80 rounded-full flex items-center justify-center text-primary-foreground text-sm font-bold shadow-lg">
                1
              </div>
