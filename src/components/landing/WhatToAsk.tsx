...
function WhatToAsk() {
  return (
    <section className="relative py-16 px-6 overflow-hidden bg-linear-to-b from-background to-muted/20">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8 lg:pl-10 xl:pl-16">
            <div className="space-y-6">
              <h3 className="text-2xl font-bold mb-8 text-center lg:text-left">Common questions our AI answers:</h3>
