    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 pt-24">
        <div className="mb-12 overflow-hidden">
          <div className="flex items-center bg-linear-to-br from-primary/10 to-background rounded-3xl p-8 border border-primary/20">
            {/* TEXT SECTION – 75% */}
            <div className="w-full md:w-3/4 space-y-4 text-center lg:text-left">
